...
#class(Bomb_df$Wild_or_hatch)
ggplot(Bomb_df) + aes(x=Wild_or_hatch, y=BombED.Dry.) + geom_boxplot(outlier.alpha = 0) +    geom_jitter(aes(color=Wild_or_hatch)) +
...
#the lipid content
ggplot(Bomb_df) + aes(x=Wild_or_hatch, y=X..lipid) + geom_boxplot(outlier.alpha = 0)+ geom_jitter()+
